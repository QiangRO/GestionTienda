...
namespace GestionTienda.Migrations
{
    ...
    [Migration("20221010123332_PrimeraMigracionTienda")]
    partial class PrimeraMigracionTienda
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GestionTienda.Models.Articulo", b =>
                {
            ...
            modelBuilder.Entity("GestionTienda.Models.ArticuloEtiqueta", b =>
                {
            ...
            modelBuilder.Entity("GestionTienda.Models.Categoria", b =>
                {
                    b.Property<int>("Categoria_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GestionTienda.Models.DetalleUsuario", b =>
                {
            ...
            modelBuilder.Entity("GestionTienda.Models.Etiqueta", b =>
                {
                    b.Property<int>("Etiqueta_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GestionTienda.Models.Usuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GestionTienda.Models.Articulo", b =>
                {
                    b.HasOne("GestionTienda.Models.Categoria", "Categoria")
                        .WithMany("Articulo")
            ...
            modelBuilder.Entity("GestionTienda.Models.ArticuloEtiqueta", b =>
                {
                    b.HasOne("GestionTienda.Models.Articulo", "Articulo")
                        .WithMany("ArticuloEtiqueta")
                        .HasForeignKey("Articulo_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GestionTienda.Models.Etiqueta", "Etiqueta")
                        .WithMany("ArticuloEtiqueta")
            ...
            modelBuilder.Entity("GestionTienda.Models.Usuario", b =>
                {
                    b.HasOne("GestionTienda.Models.DetalleUsuario", "DetalleUsuario")
                        .WithOne("Usuario")
                        .HasForeignKey("GestionTienda.Models.Usuario", "DetalleUsuario_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
